...
import de.kipper.websocket.data.tables.UserSessionAttributes;
...
@Repository
public class UserSessionAttributesDao extends DAOImpl<UserSessionAttributesRecord, de.kipper.websocket.data.tables.pojos.UserSessionAttributes, Record2<String, String>> {

    /**
     * Create a new UserSessionAttributesDao without any configuration
     */
    public UserSessionAttributesDao() {
        super(UserSessionAttributes.USER_SESSION_ATTRIBUTES, de.kipper.websocket.data.tables.pojos.UserSessionAttributes.class);
    }
    ...
    public UserSessionAttributesDao(Configuration configuration) {
        super(UserSessionAttributes.USER_SESSION_ATTRIBUTES, de.kipper.websocket.data.tables.pojos.UserSessionAttributes.class, configuration);
    }

    @Override
    public Record2<String, String> getId(de.kipper.websocket.data.tables.pojos.UserSessionAttributes object) {
     ...
     */
    public List<de.kipper.websocket.data.tables.pojos.UserSessionAttributes> fetchRangeOfSessionPrimaryId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<de.kipper.websocket.data.tables.pojos.UserSessionAttributes> fetchBySessionPrimaryId(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<de.kipper.websocket.data.tables.pojos.UserSessionAttributes> fetchRangeOfAttributeName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<de.kipper.websocket.data.tables.pojos.UserSessionAttributes> fetchByAttributeName(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<de.kipper.websocket.data.tables.pojos.UserSessionAttributes> fetchRangeOfAttributeBytes(byte[] lowerInclusive, byte[] upperInclusive) {
     ...
     */
    public List<de.kipper.websocket.data.tables.pojos.UserSessionAttributes> fetchByAttributeBytes(byte[]... values) {
